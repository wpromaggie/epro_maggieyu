<?php
class mod_delly_job extends rs_object
{
	...
	public static function get_jobs_sort_with_limit($filters){
		$args = array('skip'=>0,'limit'=>10,'sort'=>'created','by'=>'DESC'); //Default parameters
	...
	public static function get_job_status_by_id($job_id){
		$q = "SELECT 
					status,
					created,
					started,
