...
define('epro\HOSTNAME', gethostname());
define('epro\NUM_NODES', 1);
define('epro\MAX_JOBS', 5);

define('epro\DB_HOST', 'localhost');
define('epro\DB_USER', 'root');
define('epro\DB_PASS', '123');
define('epro\DB_NAME', 'eppctwo');

define('epro\DOMAIN', 'epro.wpromote.local');
define('epro\WPRO_DOMAIN', 'www.wpromote.local');
define('epro\SAP_DOMAIN', 'sap.wpromote.local');
