 ...
 */
 ...
 // wpro
 define("AXIS_FORMAT_NUMBER"		, 680006);
 ...
 class pData
  {
   ...
   // wpro: set format type for serie
   function setLabelFormatType($Series,$LabelFormatType="")
    {
     if ( !is_array($Series) ) { $Series = $this->convertToArray($Series); }
     foreach($Series as $Key => $Serie) { if (isset($this->Data["Series"][$Serie]) ) { $this->Data["Series"][$Serie]["LabelFormatType"] = $LabelFormatType; } }
    }    
   ...
   function initialise($Serie)
    {
     ...
     // wpro
     $this->Data["Series"][$Serie]["LabelFormatType"]		= 'dollar';
